...
var css = ".rolldate-container{font-size:20px;color:#333;text-align:center}.rolldate-container ul{margin:0;padding:0}.rolldate-container li{list-style-type:none}.rolldate-container header{position:relative;line-height:60px;font-size:18px;border-bottom:1px solid #e0e0e0}.rolldate-container .rolldate-mask{position:fixed;width:100%;height:100%;top:0;left:0;z-index:999;background-color:rgba(37,38,45,.4)}.rolldate-container .rolldate-panel{position:fixed;bottom:0;left:0;width:100%;height:273px;z-index:1000;background:#fff;transition:all .3s ease-in-out;transform:translate3d(0,273px,0)}.rolldate-container .rolldate-btn{position:absolute;left:0;top:0;height:100%;padding:0 15px;color:#666;font-size:16px;cursor:pointer;-webkit-tap-highlight-color:transparent}.rolldate-container .rolldate-confirm{left:auto;right:0;color:#007bff}.rolldate-container .rolldate-content{position:relative;top:20px}.rolldate-container .rolldate-wrapper{display:flex}.rolldate-container .rolldate-wrapper>div{flex:1;height:173px;line-height:36px;overflow:hidden;flex-basis:-8e;width:1%}.rolldate-container .rolldate-wrapper ul{margin-top:68px}.rolldate-container .rolldate-wrapper li{position:relative;height:36px}.rolldate-container .rolldate-dim{position:absolute;left:0;left:8px;right:8px;border-radius:6px;top:0;width:auto;height:68px;background:linear-gradient(0deg,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8));pointer-events:none;transform:translateZ(0);z-index:10}.rolldate-container .mask-top{border-bottom:1px solid #ebebeb}.rolldate-container .mask-center{height:36px;top:68px;z-index:0}.rolldate-container .mask-bottom{top:auto;bottom:1px;border-top:1px solid #ebebeb}.rolldate-container .fadeIn{transform:translateZ(0)}.rolldate-container .fadeOut{transform:translate3d(0,273px,0)}@media screen and (max-width:414px){.rolldate-container{font-size:18px}}@media screen and (max-width:320px){.rolldate-container{font-size:15px}}";
styleInject(css);
    ...
    for (var i = 0; i < len; i++) {
      ...
      if (f == 'YYYY') {
        ...
        for (var k = 1; k <= 12; k++) {
          ...
          var monthName = getMonthName(k, monthNameLength);
        ...
        if ([domId['YYYY'], domId['MM']].indexOf(that.wrapper.id) != -1 && _this.scroll['YYYY'] && _this.scroll['MM'] && _this.scroll['DD']) {
          ...
          if (_day != $('#' + domId['DD'] + ' li', 1).length) {
            ...
            for (var _l = 1; _l <= _day; _l++) {
              itemClass = _l == date.getDate() ? 'active' : '';
              li += '<li class="wheel-item ' + itemClass + '" data-index="' + _domMndex + '" data-value="' + (_l < 10 && showZeroBefore.date ? '0' + _l : _l) + '">' + (_l < 10 && showZeroBefore.date ? '0' + _l : _l) + lang.day + '</li>';
              _domMndex++;
            }
